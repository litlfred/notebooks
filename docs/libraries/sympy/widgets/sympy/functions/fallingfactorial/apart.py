"""
Widget for SymPy FallingFactorial.apart method
"""
...
class SymPyFallingFactorialApartWidget:
    """Widget for SymPy FallingFactorial.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the FallingFactorial.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-fallingfactorial-apart',
