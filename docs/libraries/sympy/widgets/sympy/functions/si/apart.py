"""
Widget for SymPy Si.apart method
"""
...
class SymPySiApartWidget:
    """Widget for SymPy Si.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Si.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-si-apart',
                    'class_name': 'Si',
                    'method_name': 'apart',
