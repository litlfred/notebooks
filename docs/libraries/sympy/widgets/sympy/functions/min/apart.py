"""
Widget for SymPy Min.apart method
"""
...
class SymPyMinApartWidget:
    """Widget for SymPy Min.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Min.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-min-apart',
                    'class_name': 'Min',
                    'method_name': 'apart',
