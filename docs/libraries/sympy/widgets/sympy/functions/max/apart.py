"""
Widget for SymPy Max.apart method
"""
...
class SymPyMaxApartWidget:
    """Widget for SymPy Max.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Max.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-max-apart',
                    'class_name': 'Max',
                    'method_name': 'apart',
