"""
Widget for SymPy Li.apart method
"""
...
class SymPyLiApartWidget:
    """Widget for SymPy Li.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Li.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-li-apart',
                    'class_name': 'Li',
                    'method_name': 'apart',
