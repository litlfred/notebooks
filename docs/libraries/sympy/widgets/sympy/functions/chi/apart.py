"""
Widget for SymPy Chi.apart method
"""
...
class SymPyChiApartWidget:
    """Widget for SymPy Chi.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Chi.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-chi-apart',
                    'class_name': 'Chi',
                    'method_name': 'apart',
