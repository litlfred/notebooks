"""
Widget for SymPy Piecewise.apart method
"""
...
class SymPyPiecewiseApartWidget:
    """Widget for SymPy Piecewise.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Piecewise.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-piecewise-apart',
