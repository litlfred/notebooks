"""
Widget for SymPy SingularityFunction.apart method
"""
...
class SymPySingularityFunctionApartWidget:
    """Widget for SymPy SingularityFunction.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the SingularityFunction.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-singularityfunction-apart',
