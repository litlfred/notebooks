"""
Widget for SymPy RisingFactorial.apart method
"""
...
class SymPyRisingFactorialApartWidget:
    """Widget for SymPy RisingFactorial.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the RisingFactorial.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-risingfactorial-apart',
