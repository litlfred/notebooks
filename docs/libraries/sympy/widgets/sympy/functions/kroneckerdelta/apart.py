"""
Widget for SymPy KroneckerDelta.apart method
"""
...
class SymPyKroneckerDeltaApartWidget:
    """Widget for SymPy KroneckerDelta.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the KroneckerDelta.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-kroneckerdelta-apart',
