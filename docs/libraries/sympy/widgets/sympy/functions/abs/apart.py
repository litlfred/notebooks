"""
Widget for SymPy Abs.apart method
"""
...
class SymPyAbsApartWidget:
    """Widget for SymPy Abs.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Abs.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-abs-apart',
                    'class_name': 'Abs',
                    'method_name': 'apart',
