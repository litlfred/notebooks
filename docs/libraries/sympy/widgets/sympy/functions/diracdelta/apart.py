"""
Widget for SymPy DiracDelta.apart method
"""
...
class SymPyDiracDeltaApartWidget:
    """Widget for SymPy DiracDelta.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the DiracDelta.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-diracdelta-apart',
