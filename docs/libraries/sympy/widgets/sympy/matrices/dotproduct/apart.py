"""
Widget for SymPy DotProduct.apart method
"""
...
class SymPyDotProductApartWidget:
    """Widget for SymPy DotProduct.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the DotProduct.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-dotproduct-apart',
