"""
Widget for SymPy MatMul.adjoint method
"""
...
class SymPyMatMulAdjointWidget:
    """Widget for SymPy MatMul.adjoint operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the MatMul.adjoint operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-matmul-adjoint',
                    'class_name': 'MatMul',
                    'method_name': 'adjoint',
