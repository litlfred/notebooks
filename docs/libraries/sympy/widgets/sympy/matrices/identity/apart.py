"""
Widget for SymPy Identity.apart method
"""
...
class SymPyIdentityApartWidget:
    """Widget for SymPy Identity.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Identity.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-identity-apart',
                    'class_name': 'Identity',
                    'method_name': 'apart',
