"""
Widget for SymPy HadamardPower.apart method
"""
...
class SymPyHadamardPowerApartWidget:
    """Widget for SymPy HadamardPower.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the HadamardPower.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-hadamardpower-apart',
