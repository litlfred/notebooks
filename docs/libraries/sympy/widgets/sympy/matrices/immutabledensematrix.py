"""
Widget for SymPy ImmutableDenseMatrix class
"""
...
class SymPyImmutableDenseMatrixWidget:
    """Widget for SymPy ImmutableDenseMatrix operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the ImmutableDenseMatrix operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-immutabledensematrix',
