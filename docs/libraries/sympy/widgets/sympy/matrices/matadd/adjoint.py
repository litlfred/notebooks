"""
Widget for SymPy MatAdd.adjoint method
"""
...
class SymPyMatAddAdjointWidget:
    """Widget for SymPy MatAdd.adjoint operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the MatAdd.adjoint operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-matadd-adjoint',
                    'class_name': 'MatAdd',
                    'method_name': 'adjoint',
