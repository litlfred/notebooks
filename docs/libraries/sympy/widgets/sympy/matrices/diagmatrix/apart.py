"""
Widget for SymPy DiagMatrix.apart method
"""
...
class SymPyDiagMatrixApartWidget:
    """Widget for SymPy DiagMatrix.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the DiagMatrix.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-diagmatrix-apart',
