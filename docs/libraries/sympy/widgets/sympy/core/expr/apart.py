"""
Widget for SymPy Expr.apart method
"""
...
class SymPyExprApartWidget:
    """Widget for SymPy Expr.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Expr.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-expr-apart',
                    'class_name': 'Expr',
                    'method_name': 'apart',
