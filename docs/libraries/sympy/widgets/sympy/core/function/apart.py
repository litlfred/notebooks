"""
Widget for SymPy Function.apart method
"""
...
class SymPyFunctionApartWidget:
    """Widget for SymPy Function.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Function.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-function-apart',
                    'class_name': 'Function',
                    'method_name': 'apart',
