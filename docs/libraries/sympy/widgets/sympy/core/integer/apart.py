"""
Widget for SymPy Integer.apart method
"""
...
class SymPyIntegerApartWidget:
    """Widget for SymPy Integer.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Integer.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-integer-apart',
                    'class_name': 'Integer',
                    'method_name': 'apart',
