"""
Widget for SymPy GreaterThan class
"""
...
class SymPyGreaterThanWidget:
    """Widget for SymPy GreaterThan operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the GreaterThan operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-greaterthan',
