"""
Widget for SymPy Lambda.apart method
"""
...
class SymPyLambdaApartWidget:
    """Widget for SymPy Lambda.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Lambda.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-lambda-apart',
                    'class_name': 'Lambda',
                    'method_name': 'apart',
