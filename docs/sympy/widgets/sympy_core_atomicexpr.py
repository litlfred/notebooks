"""
Widget for SymPy AtomicExpr class
"""
...
class SymPyAtomicExprWidget:
    """Widget for SymPy AtomicExpr operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the AtomicExpr operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-atomicexpr',
