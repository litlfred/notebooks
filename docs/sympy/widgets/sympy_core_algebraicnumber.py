"""
Widget for SymPy AlgebraicNumber class
"""
...
class SymPyAlgebraicNumberWidget:
    """Widget for SymPy AlgebraicNumber operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the AlgebraicNumber operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-algebraicnumber',
