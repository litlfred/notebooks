"""
Widget for SymPy AlgebraicNumber.adjoint method
"""
...
class SymPyAlgebraicNumberAdjointWidget:
    """Widget for SymPy AlgebraicNumber.adjoint operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the AlgebraicNumber.adjoint operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-algebraicnumber-adjoint',
