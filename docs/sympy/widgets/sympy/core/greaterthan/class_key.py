"""
Widget for SymPy GreaterThan.class_key method
"""
...
class SymPyGreaterThanClasskeyWidget:
    """Widget for SymPy GreaterThan.class_key operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the GreaterThan.class_key operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-greaterthan-class_key',
