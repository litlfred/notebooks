"""
Widget for SymPy GreaterThan.as_set method
"""
...
class SymPyGreaterThanAssetWidget:
    """Widget for SymPy GreaterThan.as_set operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the GreaterThan.as_set operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-greaterthan-as_set',
