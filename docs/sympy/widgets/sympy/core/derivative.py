"""
Widget for SymPy Derivative class
"""
...
class SymPyDerivativeWidget:
    """Widget for SymPy Derivative operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Derivative operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-derivative',
