"""
Widget for SymPy Le.class_key method
"""
...
class SymPyLeClasskeyWidget:
    """Widget for SymPy Le.class_key operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Le.class_key operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-le-class_key',
                    'class_name': 'Le',
