"""
Widget for SymPy Derivative.apart method
"""
...
class SymPyDerivativeApartWidget:
    """Widget for SymPy Derivative.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Derivative.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-derivative-apart',
