"""
Widget for SymPy Integer.adjoint method
"""
...
class SymPyIntegerAdjointWidget:
    """Widget for SymPy Integer.adjoint operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Integer.adjoint operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-integer-adjoint',
                    'class_name': 'Integer',
                    'method_name': 'adjoint',
