"""
Widget for SymPy Lambda.as_base_exp method
"""
...
class SymPyLambdaAsbaseexpWidget:
    """Widget for SymPy Lambda.as_base_exp operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Lambda.as_base_exp operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-lambda-as_base_exp',
                    'class_name': 'Lambda',
