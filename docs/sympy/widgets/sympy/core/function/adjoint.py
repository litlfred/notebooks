"""
Widget for SymPy Function.adjoint method
"""
...
class SymPyFunctionAdjointWidget:
    """Widget for SymPy Function.adjoint operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Function.adjoint operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-function-adjoint',
                    'class_name': 'Function',
                    'method_name': 'adjoint',
