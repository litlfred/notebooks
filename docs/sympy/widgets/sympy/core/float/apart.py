"""
Widget for SymPy Float.apart method
"""
...
class SymPyFloatApartWidget:
    """Widget for SymPy Float.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Float.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-float-apart',
                    'class_name': 'Float',
                    'method_name': 'apart',
