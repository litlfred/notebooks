"""
Widget for SymPy Eq.as_poly method
"""
...
class SymPyEqAspolyWidget:
    """Widget for SymPy Eq.as_poly operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Eq.as_poly operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-eq-as_poly',
                    'class_name': 'Eq',
                    'method_name': 'as_poly',
