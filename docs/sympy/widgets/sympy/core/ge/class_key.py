"""
Widget for SymPy Ge.class_key method
"""
...
class SymPyGeClasskeyWidget:
    """Widget for SymPy Ge.class_key operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Ge.class_key operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-ge-class_key',
                    'class_name': 'Ge',
