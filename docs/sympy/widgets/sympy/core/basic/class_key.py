"""
Widget for SymPy Basic.class_key method
"""
...
class SymPyBasicClasskeyWidget:
    """Widget for SymPy Basic.class_key operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Basic.class_key operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-basic-class_key',
                    'class_name': 'Basic',
