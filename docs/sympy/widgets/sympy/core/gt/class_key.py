"""
Widget for SymPy Gt.class_key method
"""
...
class SymPyGtClasskeyWidget:
    """Widget for SymPy Gt.class_key operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Gt.class_key operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-gt-class_key',
                    'class_name': 'Gt',
