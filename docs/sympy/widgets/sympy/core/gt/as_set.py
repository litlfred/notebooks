"""
Widget for SymPy Gt.as_set method
"""
...
class SymPyGtAssetWidget:
    """Widget for SymPy Gt.as_set operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Gt.as_set operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-gt-as_set',
                    'class_name': 'Gt',
                    'method_name': 'as_set',
