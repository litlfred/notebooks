"""
Widget for SymPy DiagonalOf.apart method
"""
...
class SymPyDiagonalOfApartWidget:
    """Widget for SymPy DiagonalOf.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the DiagonalOf.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-diagonalof-apart',
