"""
Widget for SymPy DiagonalOf.as_base_exp method
"""
...
class SymPyDiagonalOfAsbaseexpWidget:
    """Widget for SymPy DiagonalOf.as_base_exp operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the DiagonalOf.as_base_exp operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-diagonalof-as_base_exp',
