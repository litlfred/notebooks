"""
Widget for SymPy HadamardProduct class
"""
...
class SymPyHadamardProductWidget:
    """Widget for SymPy HadamardProduct operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the HadamardProduct operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-hadamardproduct',
