"""
Widget for SymPy MatMul.args_cnc method
"""
...
class SymPyMatMulArgscncWidget:
    """Widget for SymPy MatMul.args_cnc operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the MatMul.args_cnc operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-matmul-args_cnc',
                    'class_name': 'MatMul',
