"""
Widget for SymPy MatMul.apart method
"""
...
class SymPyMatMulApartWidget:
    """Widget for SymPy MatMul.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the MatMul.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-matmul-apart',
                    'class_name': 'MatMul',
                    'method_name': 'apart',
