"""
Widget for SymPy ImmutableSparseMatrix.LDLsolve method
"""
...
class SymPyImmutableSparseMatrixLdlsolveWidget:
    """Widget for SymPy ImmutableSparseMatrix.LDLsolve operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the ImmutableSparseMatrix.LDLsolve operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-immutablesparsematrix-LDLsolve',
