"""
Widget for SymPy MatAdd.apart method
"""
...
class SymPyMatAddApartWidget:
    """Widget for SymPy MatAdd.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the MatAdd.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-matadd-apart',
                    'class_name': 'MatAdd',
                    'method_name': 'apart',
