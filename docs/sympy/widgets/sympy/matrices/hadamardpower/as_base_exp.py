"""
Widget for SymPy HadamardPower.as_base_exp method
"""
...
class SymPyHadamardPowerAsbaseexpWidget:
    """Widget for SymPy HadamardPower.as_base_exp operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the HadamardPower.as_base_exp operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-hadamardpower-as_base_exp',
