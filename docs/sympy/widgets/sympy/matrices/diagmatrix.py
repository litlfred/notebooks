"""
Widget for SymPy DiagMatrix class
"""
...
class SymPyDiagMatrixWidget:
    """Widget for SymPy DiagMatrix operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the DiagMatrix operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-diagmatrix',
