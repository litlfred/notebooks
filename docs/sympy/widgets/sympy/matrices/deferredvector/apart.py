"""
Widget for SymPy DeferredVector.apart method
"""
...
class SymPyDeferredVectorApartWidget:
    """Widget for SymPy DeferredVector.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the DeferredVector.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-deferredvector-apart',
