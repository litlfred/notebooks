"""
Widget for SymPy HadamardPower class
"""
...
class SymPyHadamardPowerWidget:
    """Widget for SymPy HadamardPower operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the HadamardPower operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-hadamardpower',
