"""
Widget for SymPy Inverse.adjoint method
"""
...
class SymPyInverseAdjointWidget:
    """Widget for SymPy Inverse.adjoint operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Inverse.adjoint operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-inverse-adjoint',
                    'class_name': 'Inverse',
                    'method_name': 'adjoint',
