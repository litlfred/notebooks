"""
Widget for SymPy Inverse.apart method
"""
...
class SymPyInverseApartWidget:
    """Widget for SymPy Inverse.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Inverse.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-inverse-apart',
                    'class_name': 'Inverse',
                    'method_name': 'apart',
