"""
Widget for SymPy ImmutableMatrix.LDLsolve method
"""
...
class SymPyImmutableMatrixLdlsolveWidget:
    """Widget for SymPy ImmutableMatrix.LDLsolve operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the ImmutableMatrix.LDLsolve operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-immutablematrix-LDLsolve',
