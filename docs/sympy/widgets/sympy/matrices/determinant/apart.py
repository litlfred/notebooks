"""
Widget for SymPy Determinant.apart method
"""
...
class SymPyDeterminantApartWidget:
    """Widget for SymPy Determinant.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Determinant.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-determinant-apart',
