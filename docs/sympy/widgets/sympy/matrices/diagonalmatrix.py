"""
Widget for SymPy DiagonalMatrix class
"""
...
class SymPyDiagonalMatrixWidget:
    """Widget for SymPy DiagonalMatrix operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the DiagonalMatrix operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-diagonalmatrix',
