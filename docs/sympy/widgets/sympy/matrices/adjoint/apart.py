"""
Widget for SymPy Adjoint.apart method
"""
...
class SymPyAdjointApartWidget:
    """Widget for SymPy Adjoint.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Adjoint.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-adjoint-apart',
                    'class_name': 'Adjoint',
                    'method_name': 'apart',
