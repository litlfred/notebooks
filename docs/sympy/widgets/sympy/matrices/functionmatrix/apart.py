"""
Widget for SymPy FunctionMatrix.apart method
"""
...
class SymPyFunctionMatrixApartWidget:
    """Widget for SymPy FunctionMatrix.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the FunctionMatrix.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-functionmatrix-apart',
