"""
Widget for SymPy FunctionMatrix.as_base_exp method
"""
...
class SymPyFunctionMatrixAsbaseexpWidget:
    """Widget for SymPy FunctionMatrix.as_base_exp operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the FunctionMatrix.as_base_exp operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-functionmatrix-as_base_exp',
