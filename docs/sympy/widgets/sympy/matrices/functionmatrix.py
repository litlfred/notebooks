"""
Widget for SymPy FunctionMatrix class
"""
...
class SymPyFunctionMatrixWidget:
    """Widget for SymPy FunctionMatrix operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the FunctionMatrix operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-functionmatrix',
