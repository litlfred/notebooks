"""
Widget for SymPy HadamardProduct.apart method
"""
...
class SymPyHadamardProductApartWidget:
    """Widget for SymPy HadamardProduct.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the HadamardProduct.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-matrices-hadamardproduct-apart',
