"""
Widget for SymPy Ci.adjoint method
"""
...
class SymPyCiAdjointWidget:
    """Widget for SymPy Ci.adjoint operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Ci.adjoint operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-ci-adjoint',
                    'class_name': 'Ci',
                    'method_name': 'adjoint',
