"""
Widget for SymPy LambertW.adjoint method
"""
...
class SymPyLambertWAdjointWidget:
    """Widget for SymPy LambertW.adjoint operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the LambertW.adjoint operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-lambertw-adjoint',
                    'class_name': 'LambertW',
                    'method_name': 'adjoint',
