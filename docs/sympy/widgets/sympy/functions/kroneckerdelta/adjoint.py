"""
Widget for SymPy KroneckerDelta.adjoint method
"""
...
class SymPyKroneckerDeltaAdjointWidget:
    """Widget for SymPy KroneckerDelta.adjoint operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the KroneckerDelta.adjoint operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-kroneckerdelta-adjoint',
