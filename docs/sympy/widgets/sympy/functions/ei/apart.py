"""
Widget for SymPy Ei.apart method
"""
...
class SymPyEiApartWidget:
    """Widget for SymPy Ei.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Ei.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-ei-apart',
                    'class_name': 'Ei',
                    'method_name': 'apart',
