"""
Widget for SymPy Ynm.apart method
"""
...
class SymPyYnmApartWidget:
    """Widget for SymPy Ynm.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Ynm.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-ynm-apart',
                    'class_name': 'Ynm',
                    'method_name': 'apart',
