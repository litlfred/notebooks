"""
Widget for SymPy Ynm.adjoint method
"""
...
class SymPyYnmAdjointWidget:
    """Widget for SymPy Ynm.adjoint operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Ynm.adjoint operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-ynm-adjoint',
                    'class_name': 'Ynm',
                    'method_name': 'adjoint',
