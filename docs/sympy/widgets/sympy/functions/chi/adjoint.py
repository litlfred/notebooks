"""
Widget for SymPy Chi.adjoint method
"""
...
class SymPyChiAdjointWidget:
    """Widget for SymPy Chi.adjoint operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Chi.adjoint operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-chi-adjoint',
                    'class_name': 'Chi',
                    'method_name': 'adjoint',
