"""
Widget for SymPy LambertW class
"""
...
class SymPyLambertWWidget:
    """Widget for SymPy LambertW operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the LambertW operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-lambertw',
                    'class_name': 'LambertW',
