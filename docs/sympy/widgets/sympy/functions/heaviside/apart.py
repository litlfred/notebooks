"""
Widget for SymPy Heaviside.apart method
"""
...
class SymPyHeavisideApartWidget:
    """Widget for SymPy Heaviside.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Heaviside.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-heaviside-apart',
