"""
Widget for SymPy Heaviside.adjoint method
"""
...
class SymPyHeavisideAdjointWidget:
    """Widget for SymPy Heaviside.adjoint operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Heaviside.adjoint operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-heaviside-adjoint',
