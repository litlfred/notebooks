"""
Widget for SymPy Shi.apart method
"""
...
class SymPyShiApartWidget:
    """Widget for SymPy Shi.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the Shi.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-functions-shi-apart',
                    'class_name': 'Shi',
                    'method_name': 'apart',
