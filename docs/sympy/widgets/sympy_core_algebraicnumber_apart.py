"""
Widget for SymPy AlgebraicNumber.apart method
"""
...
class SymPyAlgebraicNumberApartWidget:
    """Widget for SymPy AlgebraicNumber.apart operations."""
    
    def __init__(self, schema: Dict[str, Any]):
        self.schema = schema
    
    def execute(self, validated_input: Dict[str, Any]) -> Dict[str, Any]:
        """Execute the AlgebraicNumber.apart operation."""
        try:
            ...
            return {
                ...
                'latex': latex_str,
                'metadata': {
                    'widget_id': 'sympy-core-algebraicnumber-apart',
